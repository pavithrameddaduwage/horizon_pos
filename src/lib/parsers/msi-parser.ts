// Parser for MSI Enterprise POS Data Feeds

import { MsiRow, ParseResult } from '../types/pos';
...
export function parseMsiCSV(csvContent: string): ParseResult<MsiRow> {
  const result: ParseResult<MsiRow> = {
    success: true,
    retailer: 'MSI',
    detectedDepartments: [],
    totalRows: 0,
...
export const parseMisCSV = parseMsiCSV;
