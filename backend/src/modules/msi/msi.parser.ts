...
export interface MsiParseResult {
  success: boolean;
  retailer: 'MSI';
...
export function parseMsiCSV(csvContent: string): MsiParseResult {
  const result: MsiParseResult = {
    success: true,
    retailer: 'MSI',
    detectedDepartments: [],
    totalRows: 0,
